...
export function useResize() {
  onMounted(() => {
    ...
    function onUp() {
      ...
      if (panel === leftPanel) {
        localStorage.setItem('lv_railWidth', parseInt(panel.style.width))
      } else {
        localStorage.setItem('lv_detailWidth', parseInt(panel.style.getPropertyValue('--detail-width')))
      }
      handle = panel = null
    }
    ...
    const onLeftDown = (e) => onDown(e, leftHandle, leftPanel, 1)
    const onRightDown = (e) => onDown(e, rightHandle, rightPanel, -1)
