...
/* Action constants — used in ContextMenu.vue event delegation */
const ACTIONS = {
  VISIT: 'visit',
  EDIT: 'edit',
  DELETE: 'delete',
...
const DEFAULTS = {
  ...
  bookmarks: [
    ...
    { id: 'b4', title: '抖音', url: 'https://www.douyin.com', username: '', password: '', notes: '短视频平台', icon: '', categoryId: 'social', parentId: null, order: 3, useCount: 0, attributes: { 'china-available': true }, isExpanded: false, createdAt: Date.now() - 345600000 },
  ...
  siblingGroups: [
    {
      ...
      notes: '<h1>🎉 欢迎使用 LinkVault</h1>'
        ...
        + '<li><strong>🏷️ 属性标签</strong> — 自定义属性筛选，快速定位目标书签</li>'
...
export { STORAGE_KEY, CAT_ALL, CAT_UNCATEGORIZED, ATTR_IS_GROUP, MAX_SUGGESTIONS, TOAST_FADE_MS, TOAST_REMOVE_MS, PAYLOAD_KEY, DRAG_SRC_DETAIL, UI_STATE_KEY, MAX_UNDO, UNDO_WINDOW, MAX_UNDO_BYTES, ACTIONS, DEFAULTS };
